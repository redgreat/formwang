defmodule FormwangWeb.CoreComponents do
  @moduledoc """
  Provides core UI components.

  At first glance, this module may seem daunting, but its goal is to provide
  core building blocks for your application. The components in this module are
  meant to be copied and pasted into your application and customized to your
  liking.
  ...
  You can find the icon name on the Heroicons website and then use it in this component.
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FormwangWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FormwangWeb.Gettext, "errors", msg, opts)
    end
  end
